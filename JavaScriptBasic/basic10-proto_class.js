...
// 객체 생성자. 객체 생성자는 함수를 통해 새로운 객체를 만들고
...
// 각 객체에 개별적으로 생성되는 것이 아닌 공통의 값을 지정할 때 사용한다.
// 프로토 타입 설정 / 함수
...
function Dog(name, sound) {
    AnimalInherit.call(this, '개', name, sound);    // call(this, ...) this 로 처리
}
Dog.prototype = AnimalInherit.prototype;            // prototype 을 공유하기 위해서 설정
