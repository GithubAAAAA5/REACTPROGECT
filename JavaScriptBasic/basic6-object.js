...
const dog2 = {
    ...
    sound: '멍멍!',
    say: function say() {
        console.log(this.sound); // this 는 dog2 를 가리킴.
    }
};
...
// 객체 생성 후 객체 안의 값을 수정하거나 불러올 때 사용하는 함수이다.
const numbers = {
    a: 1,
    b: 2,
